...
class SellPoint(LayableRenderObj):
    def __init__(self, game_surface: pg.Surface, pos: Sequence[int], rotation: float, map_scale: float, name: str, contents: Dict[str, float], silo: bool) -> None:
        self.game_surface = game_surface

        self.pos = pos
        self.rotation = rotation

        self.grid_surface = pg.transform.scale(ResourceManager.load_image("Sprites/grid.png"), map_scale)
        self.silo_surface = pg.transform.scale(ResourceManager.load_image("Sprites/silo.png"), map_scale)
