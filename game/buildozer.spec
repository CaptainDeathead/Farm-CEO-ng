...
source.include_exts = py,png,jpg,kv,atlas,json,ttf,otf,fon,cns,txt
...
requirements = python3,pygame-ce,android,cython,shapely,typing_extensions
...
icon.filename = %(source.dir)s/assets/Data/game_icon.png
...
android.ndk_path = ~/.buildozer/android/platform/android-ndk-r27c-linux-x86_64
